...
fig = px.scatter(positive_data, x='all_words_phrases', y='positive_collection', size='your_size_column',
...
st.table(negative_data[['spoken_negative_words', 'negattive_collection']])
