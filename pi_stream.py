...
df = pd.DataFrame({
    'Negative': df_negative['df_negative'],  # Replace 'your_negative_field' with the actual field name
    'Positive': df_positive['df_positive']   # Replace 'your_positive_field' with the actual field name
})
