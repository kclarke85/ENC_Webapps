...
df = pd.DataFrame({
    'Negative': df_negative['Negative Encounter'],  # Replace 'your_negative_field' with the actual field name
    'Positive': df_positive['Positive Encounter']   # Replace 'your_positive_field' with the actual field name
})
